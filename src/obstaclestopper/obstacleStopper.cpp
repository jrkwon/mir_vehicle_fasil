...
# Author: Jaerock Kwon
# ----------------------------------------------------------------------------
# 12/02/2017: Change two variables having 'c', 'a', 't' ...
#            to have 'm', 'i', 'r'  in the obstacleStopper_initialize() 
#
# ----------------------------------------------------------------------------
*/
...
// 12/02/2017 Jaerock Kwon:
#define ROBOT_NAME      "/bulldogbolt" /* "/mirvehicle" */
...
void obstacleStopper_initialize(void)
{
  ...
  {
    /* -------------------
    12/02/2017: Jaerock Kwon - Comment out to redefine
    ...
    ---------------------- */
    // 12/02/2017: Jaerock Kwon
    static const char_T tmp[] =   ROBOT_NAME"/cmd_vel_safe";
    static const char_T tmp_0[] = ROBOT_NAME"/cmd_vel"; 
    static const char_T tmp_1[] = ROBOT_NAME"/distanceEstimator/dist";

#define MAX_BUF  50	// this must be bigger than strlen(ROBOT_NAME"/distanceEstimator/dist")+1
    char_T tmp_2[MAX_BUF];
    char_T tmp_3[MAX_BUF];
    int32_T i;

    int32_T len, len0, len1;
    ...
    obstacleStopper_B.cv0[len1] = '\x00';
